...
If you chose **Option B** above, follow this complete deployment process to create your own virtual blockchain:
...
- **Node.js** - For npm dependency management [Install Node.js](https://nodejs.org/en/download/)
...
5. **Contract Deployment** - Deploys the complete [EVVM ecosystem](./intro.md) on your chosen host blockchain using `DeployTestnet.s.sol`

...
library SignatureUtils {
    ...
    function verifyMessageSignedForPreRegistrationEmail(
        uint256 evvmID,
        address signer,
        bytes32 _hashEmail,
        uint256 _nameServiceNonce,
        ...
        return
            SignatureRecover.signatureVerification(
                ...
                string.concat(
                    AdvancedStrings.bytes32ToString(_hashEmail),
                    ",",
                    Strings.toString(_nameServiceNonce)
                ),
                signature,
    ...
    function verifyMessageSignedForRegistrationEmail(
        uint256 evvmID,
        address signer,
    ...
    function verifyMessageSignedForPreRegistrationPhoneNumber(
        uint256 evvmID,
        address signer,
        bytes32 _hashPhoneNumber,
        uint256 _nameServiceNonce,
        bytes memory signature
    ) internal pure returns (bool) {
        return
            SignatureRecover.signatureVerification(
                ...
                string.concat(
                    AdvancedStrings.bytes32ToString(_hashPhoneNumber),
                    ",",
                    Strings.toString(_nameServiceNonce)
                ),
                signature,
    ...
    function verifyMessageSignedForRegistrationPhoneNumber(
        uint256 evvmID,
        address signer,

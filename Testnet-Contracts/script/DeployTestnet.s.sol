...
import {MockEmailRegistry} from "@evvm/testnet-contracts/contracts/nameService/MockEmailRegistry.sol";
import {MockPhoneRegistry} from "@evvm/testnet-contracts/contracts/nameService/MockPhoneRegistry.sol";
...
contract DeployTestnet is Script {
    ...
    Treasury treasury;
    P2PSwap p2pSwap;
    MockEmailRegistry emailRegistry;
    MockPhoneRegistry phoneRegistry;
    ...
    function run() public {
        ...
        EvvmStructs.EvvmMetadata memory inputMetadata = EvvmStructs
            .EvvmMetadata({
                ...
                EvvmID: 0, ///@dev EvvmID will be assigned manually after deployment
        ...
        // Deploy mock registries for email and phone
        emailRegistry = new MockEmailRegistry();
        phoneRegistry = new MockPhoneRegistry();

        // NOTE: quickSetupRegistries requires admin privileges and must be called manually by the admin
        // nameService.quickSetupRegistries(address(emailRegistry), address(phoneRegistry));
        // To set up registries manually, the admin should call:
        // nameService.quickSetupRegistries(address(emailRegistry), address(phoneRegistry));
        ...
        console2.log("EmailRegistry deployed at:", address(emailRegistry));
        console2.log("PhoneRegistry deployed at:", address(phoneRegistry));
